...
func (x *BatchHeader) GetLeaderID() uint64 {
	if x != nil {
		return x.LeaderID
	}
	return 0
...
func (x *BatchHeader) GetBlockNum() uint64 {
	if x != nil {
		return x.BlockNum
	}
	return 0
...
var file_src_message_batch_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x08, 0x6c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x62,
