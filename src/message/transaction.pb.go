...
type TransactionBody struct {
	...
	DecryptParams string   `protobuf:"bytes,1,opt,name=decryptParams,proto3" json:"decryptParams,omitempty"`
	PkIDs         []uint32 `protobuf:"varint,2,rep,packed,name=pkIDs,proto3" json:"pkIDs,omitempty"`
}
...
var file_src_message_transaction_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x61, 0x6d, 0x6d, 0x61, 0x47, 0x32, 0x22, 0x4d, 0x0a, 0x0f,
