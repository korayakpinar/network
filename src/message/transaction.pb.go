...
func (x *TransactionHeader) GetGammaG2() string {
	if x != nil {
		return x.GammaG2
	}
	return ""
...
type TransactionBody struct {
	...
	PkIDs   []uint32 `protobuf:"varint,1,rep,packed,name=pkIDs,proto3" json:"pkIDs,omitempty"` // List of public key IDs
	Sa1     []string `protobuf:"bytes,2,rep,name=sa1,proto3" json:"sa1,omitempty"`             // String array of length 2
	Sa2     []string `protobuf:"bytes,3,rep,name=sa2,proto3" json:"sa2,omitempty"`             // String array of length 6
	Iv      string   `protobuf:"bytes,4,opt,name=iv,proto3" json:"iv,omitempty"`               // Initialization vector for AES256, 16 bytes long
	EncText string   `protobuf:"bytes,5,opt,name=encText,proto3" json:"encText,omitempty"`     // Encrypted text
	T       uint32   `protobuf:"varint,6,opt,name=t,proto3" json:"t,omitempty"`                // Unsigned integer field
}
...
func (x *TransactionBody) GetPkIDs() []uint32 {
	if x != nil {
		return x.PkIDs
	}
	return nil
...
func (x *TransactionBody) GetSa1() []string {
	if x != nil {
		return x.Sa1
	}
	return nil
...
func (x *TransactionBody) GetSa2() []string {
	if x != nil {
		return x.Sa2
	}
	return nil
...
func (x *TransactionBody) GetIv() string {
	if x != nil {
		return x.Iv
	}
	return ""
...
func (x *TransactionBody) GetEncText() string {
	if x != nil {
		return x.EncText
	}
	return ""
...
func (x *TransactionBody) GetT() uint32 {
	if x != nil {
		return x.T
	}
	return 0
...
var file_src_message_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x79, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x41, 0x0a, 0x11, 0x54, 0x72, 0x61,
	...
	,
