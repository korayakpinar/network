...
type TransactionHeader struct {
	...
	PkIDs   []uint32 `protobuf:"varint,3,rep,packed,name=pkIDs,proto3" json:"pkIDs,omitempty"` // List of public key IDs
}
...
func (x *TransactionHeader) GetPkIDs() []uint32 {
	if x != nil {
		return x.PkIDs
	}
	return nil
...
type TransactionBody struct {
	...
	Sa1     []string `protobuf:"bytes,1,rep,name=sa1,proto3" json:"sa1,omitempty"`         // String array of length 2
	Sa2     []string `protobuf:"bytes,2,rep,name=sa2,proto3" json:"sa2,omitempty"`         // String array of length 6
	Iv      string   `protobuf:"bytes,3,opt,name=iv,proto3" json:"iv,omitempty"`           // Initialization vector for AES256, 16 bytes long
	EncText string   `protobuf:"bytes,4,opt,name=encText,proto3" json:"encText,omitempty"` // Encrypted text
	T       uint32   `protobuf:"varint,5,opt,name=t,proto3" json:"t,omitempty"`            // Unsigned integer field
}
...
var file_src_message_transaction_proto_rawDesc = []byte{
	...
	,
