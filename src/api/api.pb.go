...
type DecryptDataRequest struct {
	...
	T   int32    `protobuf:"varint,6,opt,name=t,proto3" json:"t,omitempty"`
...
func (x *DecryptDataRequest) GetT() int32 {
	if x != nil {
		return x.T
	}
	return 0
...
func (x *DecryptDataRequest) GetN() int32 {
	if x != nil {
		return x.N
	}
	return 0
...
var file_src_api_api_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x12, 0x0c, 0x0a, 0x01, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x74,
	0x12, 0x0c, 0x0a, 0x01, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x01, 0x6e, 0x22, 0x2d,
